...
export class ValidaSMSService {

  constructor(
    private http: HttpClient
  ) {}
  
  validaCodigo(idBeneficiario: string, codigoSMS: string) {

    let payload = {
      idBeneficiario: idBeneficiario,
      codigoSMS:      codigoSMS
    };
    return this.http.put("https://apis.seconci-sp.org.br:3011/login/gravaSMSCodigo/", JSON.stringify(payload), httpOptions);
  }
