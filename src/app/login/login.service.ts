...
export class LoginService {
  ...
  public authenticate(cpfTitular: string, dataNascimento: string): Observable<any> {

    let url = 'https://apis.seconci-sp.org.br:3011/login/authenticate/' + cpfTitular + '/' + dataNascimento;
